...
#include "mlang/Diag/AllDiagnostics.h"
#include "mlang/Diag/DiagnosticCategories.h"
  ...
  if (IsFirst) {
    for (unsigned i = 1; i != StaticDiagInfoSize; ++i) {
      assert(StaticDiagInfo[i-1].DiagID != StaticDiagInfo[i].DiagID &&
             "Diag ID conflict, the enums at the start of mlang::diag (in "
