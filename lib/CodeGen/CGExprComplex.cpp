...
//    CGF.EmitStoreThroughPropertyRefLValue(RValue::getComplex(Val), LV);
  ...
  ComplexPairTy EmitComplexToComplexCast(ComplexPairTy Val, Type SrcType,
                                         Type DestType);
...
//  }
  ...
  // l-values.
  ComplexPairTy VisitDefnRefExpr(const Expr *E) { return EmitLoadOfLValue(E); }
  ComplexPairTy VisitArrayIndex(Expr *E) { return EmitLoadOfLValue(E); }
  ...
  ComplexPairTy EmitCast(CastKind CK, Expr *Op, Type DestTy);
//  ComplexPairTy VisitImplicitCastExpr(ImplicitCastExpr *E) {
//    // Unlike for scalars, we don't have to worry about function->ptr demotion
//    // here.
//    return EmitCast(E->getCastKind(), E->getSubExpr(), E->getType());
//  }
  ComplexPairTy VisitFunctionCall(const FunctionCall *E);
...
//    Type Elem = E->getType()->getAs<ComplexType>()->getElementType();
...
ComplexPairTy ComplexExprEmitter::VisitFunctionCall(const FunctionCall *E) {
  if (E->getCallReturnType()->isReferenceType())
    return EmitLoadOfLValue(E);

  return CGF.EmitFunctionCall(E).getComplexVal();
}
...
//                    CGF.ConvertType(CGF.getContext().getPointerType(DestTy)));
    ...
    return EmitLoadOfComplex(V, false);
  }
...
ComplexPairTy ComplexExprEmitter::VisitInitListExpr(InitListExpr *E) {
  ...
  Type Ty = E->getType()/*->getAs<ComplexType>()->getElementType()*/;
...
ComplexPairTy CodeGenFunction::EmitComplexExpr(const Expr *E, bool IgnoreReal,
                                               bool IgnoreImag) {
  assert(E && E->getType().hasComplexAttr() &&
...
EmitComplexCompoundAssignmentLValue(const CompoundAssignOperator *E) {
  ...
  case BO_RDivAssign: Op = &ComplexExprEmitter::EmitBinDiv; break;
  case BO_LDivAssign: Op = &ComplexExprEmitter::EmitBinDiv; break;
