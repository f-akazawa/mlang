...
#ifndef MLANG_CODEGEN_TARGETINFO_H_
#define MLANG_CODEGEN_TARGETINFO_H_
...
namespace mlang {
  ...
  public:
    ...
    virtual void SetTargetAttributes(const Defn *D, llvm::GlobalValue *GV,
...
#endif /* MLANG_CODEGEN_TARGETINFO_H_ */
