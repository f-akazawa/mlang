//===--- CompilerInstance.cpp - CompilerInstance ----------------*- C++ -*-===//
//
...
static void SetUpBuildDumpLog(const DiagnosticOptions &DiagOpts,
  ...
  (*OS) << "mlang -cc1 command line arguments: ";
...
void CompilerInstance::createPreprocessor() {
  PP = createPreprocessor(getDiagnostics(), getLangOpts(),
                          getPreprocessorOpts(), getImportSearchOpts(),
...
CompilerInstance::createPreprocessor(DiagnosticsEngine &Diags,
  ...
  ImportSearch *HeaderInfo = new ImportSearch(FileMgr);
