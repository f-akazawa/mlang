...
#ifndef MLANG_LIB_DRIVER_TOOLS_H_
#define MLANG_LIB_DRIVER_TOOLS_H_
...
namespace tools {
  ...
  public:
    Clang(const ToolChain &TC) : Tool("mlang", "mlang frontend", TC) {}
  ...
  public:
    ClangAs(const ToolChain &TC) : Tool("mlang::as",
                                        "mlang integrated assembler", TC) {}
