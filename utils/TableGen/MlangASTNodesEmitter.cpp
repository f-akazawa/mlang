//=== MlangASTNodesEmitter.cpp - Generate Mlang AST node tables -*- C++ -*-===//
//
...
std::pair<Record *, Record *> MlangASTNodesEmitter::EmitNode(
                                                           const ChildMap &Tree,
                                                           raw_ostream &OS,
                                                           Record *Base) {
...
void MlangASTNodesEmitter::run(raw_ostream &OS) {
  // Write the preamble
...
void MlangDeclContextEmitter::run(raw_ostream &OS) {
