//===--- Lexer.h - M Language Lexer for Mlang  ------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
//  This file defines Lexer.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_LEX_LEXER_H_
#define MLANG_LEX_LEXER_H_
...
public:
	...
	const LangOptions &getFeatures() const {
		return Features;
	}
	...
	static SourceLocation AdvanceToTokenCharacter(SourceLocation TokStart,
			unsigned Character, const SourceManager &SM,
	...
	static SourceLocation getLocForEndOfToken(SourceLocation Loc,
		unsigned Offset, const SourceManager &SM,	const LangOptions &Features);
