//===--- DirectoryLookup.h - XXXXXXX for Mlang  ---------------------*- C++ -*-===//
//
...
#ifndef MLANG_LEX_DIRECTORY_LOOKUP_H_
#define MLANG_LEX_DIRECTORY_LOOKUP_H_
...
public:
  ...
  const FileEntry *LookupFile(llvm::StringRef Filename, ImportSearch &HS,
                              llvm::SmallVectorImpl<char> *SearchPath,
                              llvm::SmallVectorImpl<char> *RelativePath) const;

private:
  const FileEntry *DoFrameworkLookup(
      llvm::StringRef Filename, ImportSearch &HS,
      llvm::SmallVectorImpl<char> *SearchPath,
      llvm::SmallVectorImpl<char> *RelativePath) const;

};

// FIXME this is for refactor purposes.
class HeaderMap {
public:
...
#endif /* MLANG_LEX_DIRECTORY_LOOKUP_H_ */
