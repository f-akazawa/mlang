...
//===----------------------------------------------------------------------===//
//
//  This file defines frontend options.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_FRONTEND_FRONTEND_OPTIONS_H_
#define MLANG_FRONTEND_FRONTEND_OPTIONS_H_

#include "mlang/Frontend/CommandLineSourceLoc.h"
...
namespace frontend {
  enum ActionKind {
    ...
    PrintDefnContext,       ///< Print DeclContext and their Decls.
