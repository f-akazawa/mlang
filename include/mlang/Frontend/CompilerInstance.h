//===--- CompilerInstance.h - ComplierInstance for Mlang  -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
//  This file defines ComplierInstance.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_FRONTEND_COMPILER_INSTANCE_H_
...
//  }
  ...
  ImportSearchOptions &getImportSearchOpts() {
    return Invocation->getImportSearchOpts();
  }
  ...
  ///
  /// Note that this also creates a new ImportSearch object which will be owned
...
#endif /* MLANG_FRONTEND_COMPILER_INSTANCE_H_ */
