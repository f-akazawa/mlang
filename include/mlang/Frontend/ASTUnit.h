...
//===----------------------------------------------------------------------===//
//
// This file defines ASTUnit utility class.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_FRONTEND_ASTUNIT_H_
#define MLANG_FRONTEND_ASTUNIT_H_
...
//  ASTLocation getLastASTLocation() const { return LastLoc; }
  ...
  typedef std::vector<Defn *>::iterator top_level_iterator;

  top_level_iterator top_level_begin() {
    assert(!isMainFileAST() && "Invalid call for AST based ASTUnit!");
    return TopLevelDefns.begin();
  }

  top_level_iterator top_level_end() {
    assert(!isMainFileAST() && "Invalid call for AST based ASTUnit!");
    return TopLevelDefns.end();
  }

  std::size_t top_level_size() const {
    assert(!isMainFileAST() && "Invalid call for AST based ASTUnit!");
    return TopLevelDefns.size();
  }

  bool top_level_empty() const {
    assert(!isMainFileAST() && "Invalid call for AST based ASTUnit!");
    return TopLevelDefns.empty();
  }

  /// \brief Add a new top-level declaration.
  void addTopLevelDecl(Defn *D) {
    TopLevelDefns.push_back(D);
  }
...
#endif /* MLANG_FRONTEND_ASTUNIT_H_ */
