...
//===----------------------------------------------------------------------===//
//
//  This file defines the UsuallyTinyPtrVector class.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_AST_USUALLY_TINY_PTR_VECTOR_H_
#define MLANG_AST_USUALLY_TINY_PTR_VECTOR_H_
...
#endif /* MLANG_AST_USUALLY_TINY_PTR_VECTOR_H_ */
