...
#ifndef MLANG_DIAGNOSTIC_H
#define MLANG_DIAGNOSTIC_H
...
template<typename T>
inline
typename llvm::enable_if<llvm::is_same<T, DefnContext>,
                         const DiagnosticBuilder &>::type
operator<<(const DiagnosticBuilder &DB, T *DC) {
  DB.AddTaggedVal(reinterpret_cast<intptr_t>(DC),
                  DiagnosticsEngine::ak_defncontext);
  return DB;
}
