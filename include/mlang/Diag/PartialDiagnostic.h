...
//===----------------------------------------------------------------------===//
//
//  This file defines PartialDiagnostic.
//
//===----------------------------------------------------------------------===//

#ifndef MLANG_DIAG_PARTIAL_DIAGNOSTIC_H_
#define MLANG_DIAG_PARTIAL_DIAGNOSTIC_H_
...
#endif /* MLANG_DIAG_PARTIAL_DIAGNOSTIC_H_ */
