...
#ifndef MLANG_BASIC_FILEMANAGER_H_
#define MLANG_BASIC_FILEMANAGER_H_
...
class FileManager : public llvm::RefCountedBase<FileManager> {
  ...
  /// UniqueRealDirs/UniqueRealFiles - Cache for existing directories/files.
  ///
...
#endif /* MLANG_BASIC_FILEMANAGER_H_ */
